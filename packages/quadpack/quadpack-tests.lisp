  ...
  (labels ((soln (alpha)
	   ...
	   (quad (alpha key)
	     ...
	     (let* ((lenw (* 4 limit))
		    ...
		    (iwork (make-array limit :element-type 'integer4)))
  ...
  (labels ((soln (alpha)
	   ...
	   (quad-qagp (alpha)
	     ...
	     (let* ((points (make-array 3 :element-type 'double-float
		    ...
		    (level (make-array limit :element-type 'integer4))
		    (ndin (make-array 3 :element-type 'integer4))
  ...
  (labels (
	   ...
	   (quad-qawo (alpha)
	     ...
	     (let* ((leniw limit)
		    ...
		    (work (make-array lenw :element-type 'double-float))
		    (iwork (make-array leniw :element-type 'integer4)))
